...
function requestTrgScalersPlot() {
  ...
  createNewTab({
    service: "Download",
    context: "",
    request: { TrgScalersPlot: { run_number: var_run_number, args: trg_args } },
  });
}
...
function requestVtxPlot() {
  ...
  createNewTab({
    service: "Download",
    context: "",
    request: { VerticesPlot: { run_number: var_run_number, args: vtx_args } },
  });
}
...
function requestChronoboxPlot() {
  ...
  createNewTab({
    service: "Download",
    context: "",
    request: { ChronoboxPlot: { run_number: var_run_number, args: cb_args } },
  });
}
